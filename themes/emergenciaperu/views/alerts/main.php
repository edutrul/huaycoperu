	...
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<div class="row">
				...
				<div class="step-2-holder col m6">
					<div class="step-2">
					...
					<input id="btn-send-alerts" class="btn_submit btn red" type="submit" value="<?php echo Kohana::lang('ui_main.alerts_btn_send'); ?>" />
					<BR /><BR />
