<div id="container">
	<div class="row lista-incidencias">
		<!-- start reports block -->
		<div class="big-block">
			<h1 class="heading col s12">
				<?php echo Kohana::lang('ui_main.showing_reports_from', array(date('M d, Y', $oldest_timestamp), date('M d, Y', $latest_timestamp))); ?> 
				<a href="#" class="btn-change-time ic-time">  <i class="material-icons tiny">query_builder</i> <?php echo Kohana::lang('ui_main.change_date_range'); ?></a>
			</h1>
			...
			<div class="reports-content">
				<!-- reports-box -->
				<div id="reports-box" class="col m9">
					<?php echo $report_listing_view; ?>
				</div>
				<!-- end #reports-box -->
				
				<div id="filters-box" class="col m3">
