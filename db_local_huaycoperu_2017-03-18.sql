...
# Generation Time: 2017-03-18 08:22:52 +0000
# ************************************************************
...
INSERT INTO `category` (`id`, `parent_id`, `locale`, `category_position`, `category_title`, `category_description`, `category_color`, `category_image`, `category_image_thumb`, `category_visible`, `category_trusted`)
VALUES
	(1,0,'en_US',0,'Accidente, Muerte, Desaparecidos','Accidente, Muerte, Desaparecidos','9900CC',NULL,NULL,1,0),
	(2,0,'en_US',1,'Lluvia, huayco, inundación','Lluvia, huayco, inundación','3300FF',NULL,NULL,1,0),
	(3,0,'en_US',2,'Puerto, carretera, bloqueado','Puerto, carretera, bloqueado','663300',NULL,NULL,1,0),
	(4,0,'en_US',3,'Otros','Otros','339900',NULL,NULL,1,1);
...
INSERT INTO `country` (`id`, `iso`, `country`, `capital`, `cities`)
VALUES
...
INSERT INTO `externalapp` (`id`, `name`, `url`)
VALUES
...
# Dump of table feed_item_category
# ------------------------------------------------------------
...
INSERT INTO `form` (`id`, `form_title`, `form_description`, `form_active`)
VALUES
...
# Dump of table form_field_option
# ------------------------------------------------------------
...
INSERT INTO `incident` (`id`, `location_id`, `form_id`, `locale`, `user_id`, `incident_title`, `incident_description`, `incident_date`, `incident_mode`, `incident_active`, `incident_verified`, `incident_dateadd`, `incident_dateadd_gmt`, `incident_datemodify`, `incident_alert_status`, `incident_zoom`)
VALUES
	...
	(2,2,0,'en_US',1,'fddffdafda','fdasfdas','2017-03-18 01:32:00',1,0,0,'2017-03-18 01:36:04',NULL,NULL,0,13);

/*!40000 ALTER TABLE `incident` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table incident_category
# ------------------------------------------------------------
...
INSERT INTO `incident_category` (`id`, `incident_id`, `category_id`)
VALUES
	(1,1,1),
	(2,2,3);
...
INSERT INTO `incident_person` (`id`, `incident_id`, `person_first`, `person_last`, `person_email`, `person_phone`, `person_ip`, `person_date`)
VALUES
	(1,2,'','','',NULL,NULL,'2017-03-18 01:36:04');
...
INSERT INTO `level` (`id`, `level_title`, `level_description`, `level_weight`)
VALUES
...
INSERT INTO `location` (`id`, `location_name`, `country_id`, `latitude`, `longitude`, `location_visible`, `location_date`)
VALUES
	(1,'Nairobi',115,-1.28730007070501,36.8214511820082,1,'2009-06-30 00:00:00'),
	(2,'Río Huaycoloro, Lurigancho, Lima, Perú',174,-11.998617,-76.91603,1,'2017-03-18 01:36:04');
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Stores permissions used for access control';
...
INSERT INTO `scheduler` (`id`, `scheduler_name`, `scheduler_last`, `scheduler_weekday`, `scheduler_day`, `scheduler_hour`, `scheduler_minute`, `scheduler_controller`, `scheduler_active`)
VALUES
	(1,'Feeds',1489818197,-1,-1,-1,0,'s_feeds',1),
	(2,'Alerts',1489819641,-1,-1,-1,-1,'s_alerts',1),
	(3,'Email',1489818197,-1,-1,-1,0,'s_email',1),
	(4,'Twitter',1489818197,-1,-1,-1,0,'s_twitter',1),
	(5,'Cleanup',1489818197,-1,-1,-1,0,'s_cleanup',1);

/*!40000 ALTER TABLE `scheduler` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table scheduler_log
# ------------------------------------------------------------
...
INSERT INTO `scheduler_log` (`id`, `scheduler_id`, `scheduler_status`, `scheduler_date`)
VALUES
	(1,1,'200',1489818197),
	(2,2,'200',1489818197),
	(3,3,'200',1489818197),
...
INSERT INTO `service` (`id`, `service_name`, `service_description`, `service_url`, `service_api`)
VALUES
...
INSERT INTO `sessions` (`session_id`, `last_activity`, `data`)
VALUES
	('0937ab8fb66b154b8356df9f62bc4d03',1489819647,'');
...
VALUES
	(1,'site_name','HUAYCO PERU'),
	(2,'site_tagline','huayco'),
	(3,'site_banner_id',NULL),
	(4,'site_email','luis.eduardo.telaya@gmail.com'),
	(5,'site_key',NULL),
	(6,'site_language','es_PE'),
	(7,'site_style','default'),
	(8,'site_timezone','America/Lima'),
	...
	(27,'api_akismet',''),
	(28,'default_country','174'),
	(29,'multi_country','0'),
	(30,'default_city','nairobi'),
	(31,'default_lat','-5.22459807707365'),
	(32,'default_lon','-80.61676031845435'),
	(33,'default_zoom','13'),
	(34,'items_per_page','5'),
	...
	(43,'blocks_per_row','2'),
	(44,'date_modify','2017-03-18 01:44:49'),
	(45,'stat_id',NULL),
	(46,'stat_key',NULL),
	...
	(55,'alerts_email','luis.eduardo.telaya@gmail.com'),
	...
	(68,'forgot_password_secret','H(h(!,EYRsJ1QNHES_d6I:9ul@LMUWvq5vnKl1%WnF}UymfRzUe.!k]Rxq1by}B)'),
	(69,'scheduler_lock','0'),
...
VALUES
	(1,1,'610e016b470c22368eb456198ae70d6a91934654','VGK32x3e9GKkpyaFMAMBVkoLgyTujHLA',1489817962,1491027562);
...
INSERT INTO `users` (`id`, `riverid`, `name`, `email`, `username`, `password`, `logins`, `last_login`, `notify`, `updated`, `color`, `code`, `confirmed`, `public_profile`, `approved`, `needinfo`)
VALUES
	(1,'','Administrator','luis.eduardo.telaya@gmail.com','admin','04f1cdb33d87eb683895cde1c8588d4542b4d718e34a7603c0',1,1489817962,0,'2017-03-18 01:19:22','FF0000',NULL,1,0,1,0);
