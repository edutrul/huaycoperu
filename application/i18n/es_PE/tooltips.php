...
$lang = array(
	'actions' => array(
		'add_to_category' => 'Esto agrega categorías adicionales al incidencia. Si aquí seleccionas Categoría 1 y el incidencia ya tiene Categoría 2, el incidencia entonces tendrá ambas, Categoría 1 y Categoría 2.',
		'approve' => 'Aprueba incidencia o no. Si es aprobado, entonces se mostrará públicamente',
		...
		'report_title' => 'Este es el asunto por defecto para agregar al incidencia',
		'response' => 'Si todas las cualificaciones anteriores se pasan, el disparador se iniciará una respuesta. Esto puede ir desde la aprobación de incidencia de un usuario enviado por correo electrónico. Seleccione la respuesta aquí para activar opciones adicionales para las respuestas específicas.',
		'send_to' => 'Si selecciona "Usuario Disparador", el correo electrónico se enviará al usuario que realizó la acción. Si selecciona el botón de opción situado junto al cuadro de entrada, serás capaz de introducir una dirección de correo electrónico personalizado. Esto es útil si está configurando disparadores para notificar a las personas cuando ciertas partes del mapa están recibiendo incidencias, registros de entrada o alguna otra actividad.',
		...
		'verify' => 'Marcas incidencia como verificado o no.',
	) ,
	...
	'profile_color' => 'Puedes seleccionar un color que se mostrará bajo tu imagen de perfil en tu perfil público. Este color será también el de tu incidencias registrados en el mapa.',
	...
	'profile_notify' => 'Seleccionando SÍ recibirás alertas vía correo electrónico cuando se registren nuevos incidencias o comentarios en tu sitio web.',
	...
	'settings_allow_comments' => 'Permitir a los usuarios comentar los incidencias en la página principal del sitio.',
	...
	'settings_display_items_per_page' => 'Este es el número de incidencias mostrados en la página principal de este sitio',
	'settings_display_items_per_page_admin' => 'Este es el número de incidencias mostrados en la página en el Back End de administración',
	...
	'settings_map_timeline' => 'Esto muestra la línea de tiempo basada en la fecha y hora de los incidencias registrados. ',
	...
	'settings_server_password' => 'Esta es la contraseña para la dirección de correo electrónico donde se reciben los incidencias.',
	...
	'settings_server_username' => 'Esta es la dirección de correo electrónico que recibe los incidencias.',
	...
	'settings_site_email' => 'Esta es la dirección de correo que recibirá los incidencias y mensajes que se envíen desde el formulario de Contacto.',
	...
	'settings_site_submit_report_message' => 'Este es el mensaje que se mostrará en la página de Envía incidencia. Esto se puede aprovechar para señalar excepciones de responsabilidad o instrucciones para tus visitantes que publican incidencias. ',
